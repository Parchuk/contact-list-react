...
class ContactItem extends React.Component {
  ...
  render() {
    ...
    if (
      name.toLowerCase().includes(this.props.currentSearchValue.toLowerCase())
    ) {
      return (
        <tr>
          <td>
          ...
          <td className="text-center">
            <span
              ...
              onClick={() => contactListService.toggleStatus(id)}
            >
              {status}
            </span>
          </td>
          ...
          <td>
            ...
            <Link
              ...
              onClick={() => contactListService.onEdit(id)}
            >
              <span className="fa-stack">
                <i className="fa fa-square fa-stack-2x"></i>
            ...
            <Link to="#" className="table-link danger">
              <span
                className="fa-stack"
                onClick={() => contactListService.onDelite(id)}
              >
                <i className="fa fa-square fa-stack-2x"></i>
